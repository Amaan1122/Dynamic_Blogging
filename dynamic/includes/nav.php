...
?>
	...
	<a class="navbar-brand" href="index.php"><b>BlogPoint</b></a>
	...
	<a href="../dynamic/admin/signup.php"><button type="button" class="btn btn-dark"><b>Sign Up</b></button></a>
	
	<a href="../dynamic/admin/login.php"><button type="button" class="btn btn-dark"><b>Admin Login</b></button></a>
	
	<a href="../dynamic/admin/login.php"><button type="button" class="btn btn-dark"><b>Author Login</b></button></a>
